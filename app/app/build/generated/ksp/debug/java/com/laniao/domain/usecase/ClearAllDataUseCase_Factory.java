...
public final class ClearAllDataUseCase_Factory implements Factory<ClearAllDataUseCase> {
  ...
  public ClearAllDataUseCase_Factory(Provider<LaNiaoDatabase> databaseProvider,
  ...
  public static ClearAllDataUseCase_Factory create(
    ...
    return new ClearAllDataUseCase_Factory(Providers.asDaggerProvider(databaseProvider), Providers.asDaggerProvider(peeEntryDaoProvider), Providers.asDaggerProvider(voidScheduleDaoProvider), Providers.asDaggerProvider(waterIntakeDaoProvider), Providers.asDaggerProvider(drinkEntryDaoProvider), Providers.asDaggerProvider(exerciseScheduleDaoProvider), Providers.asDaggerProvider(exerciseCompletionDaoProvider), Providers.asDaggerProvider(appSettingsDaoProvider));
  }

  public static ClearAllDataUseCase_Factory create(Provider<LaNiaoDatabase> databaseProvider,
      Provider<PeeEntryDao> peeEntryDaoProvider, Provider<VoidScheduleDao> voidScheduleDaoProvider,
      Provider<WaterIntakeDao> waterIntakeDaoProvider,
      Provider<DrinkEntryDao> drinkEntryDaoProvider,
      Provider<ExerciseScheduleDao> exerciseScheduleDaoProvider,
      Provider<ExerciseCompletionDao> exerciseCompletionDaoProvider,
      Provider<AppSettingsDao> appSettingsDaoProvider) {
    return new ClearAllDataUseCase_Factory(databaseProvider, peeEntryDaoProvider, voidScheduleDaoProvider, waterIntakeDaoProvider, drinkEntryDaoProvider, exerciseScheduleDaoProvider, exerciseCompletionDaoProvider, appSettingsDaoProvider);
  }

  public static ClearAllDataUseCase newInstance(LaNiaoDatabase database, PeeEntryDao peeEntryDao,
    ...
    return new ClearAllDataUseCase(database, peeEntryDao, voidScheduleDao, waterIntakeDao, drinkEntryDao, exerciseScheduleDao, exerciseCompletionDao, appSettingsDao);
  }
}
